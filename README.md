...
Il y deux types d'application:

- une version qui utilise le modèle en local, chargé dans la mémoire du serveur front gradio
- une version qui utilise le modèle en ligneavec des requêtes API, le modèle lui même étant hébergé sur un conteneur Docker avec l'image TGI

### Lancement de l'application sans TGI
...
### Lancement de l'application avec TGI

Pour lancer l'application :

- lancez le conteneur Docker avec l'image TGI en executant le fichier [run_tgi.sh](./run_tgi.sh) pour linux ou le fichier [run_tgi.bat](./run_tgi.bat) pour windows (le fichier windows n'est pas testé). Assurez vous le conteneur tourne sur 8083, ou changez la ligne 5 de [api_client_app.py](./api_client_app.py)
- exécuter le fichier [api_client_app.py](./api_client_app.py) avec Python (`py api_client_app.py`)
- se rendre à l'URL suivante : http://127.0.0.1:7860
...
| **input** (_string_)                                                                                                                                | **instruct** (_string_)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | **output** (_string_)                                                                                                                                                                                                                                 |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
